 ...
 */
@JsonPropertyOrder({
  BasicProduct.JSON_PROPERTY_ORDRE_ID,
  BasicProduct.JSON_PROPERTY_ESTATE_ID,
  BasicProduct.JSON_PROPERTY_OPPDRAGSNUMMER,
  BasicProduct.JSON_PROPERTY_REGISTERENHET,
  BasicProduct.JSON_PROPERTY_BESTILLER,
  BasicProduct.JSON_PROPERTY_MEGLERKONTOR,
  BasicProduct.JSON_PROPERTY_KONTAKTPERSON
})
...
public class BasicProduct {
  ...
  public BasicProduct ordreId(@javax.annotation.Nonnull String ordreId) {
  ...
  public BasicProduct estateId(@javax.annotation.Nullable String estateId) {
  ...
  public BasicProduct oppdragsnummer(@javax.annotation.Nullable String oppdragsnummer) {
  ...
  public BasicProduct registerenhet(@javax.annotation.Nonnull Registerenhet registerenhet) {
  ...
  public BasicProduct bestiller(@javax.annotation.Nonnull Kontaktinfo bestiller) {
  ...
  public BasicProduct meglerkontor(@javax.annotation.Nonnull Meglerkontor meglerkontor) {
  ...
  public BasicProduct kontaktperson(@javax.annotation.Nonnull Kontaktinfo kontaktperson) {
  ...
  /**
   * Return true if this BasicProduct object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.ordreId, basicProduct.ordreId) &&
        Objects.equals(this.estateId, basicProduct.estateId) &&
        Objects.equals(this.oppdragsnummer, basicProduct.oppdragsnummer) &&
        Objects.equals(this.registerenhet, basicProduct.registerenhet) &&
        Objects.equals(this.bestiller, basicProduct.bestiller) &&
        Objects.equals(this.meglerkontor, basicProduct.meglerkontor) &&
        Objects.equals(this.kontaktperson, basicProduct.kontaktperson);
  }

  @Override
  public int hashCode() {
    return Objects.hash(ordreId, estateId, oppdragsnummer, registerenhet, bestiller, meglerkontor, kontaktperson);
  }
