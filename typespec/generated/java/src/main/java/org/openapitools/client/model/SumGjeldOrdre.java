 ...
 */
@JsonPropertyOrder({
  SumGjeldOrdre.JSON_PROPERTY_TYPE,
  SumGjeldOrdre.JSON_PROPERTY_ORDRE_ID,
  SumGjeldOrdre.JSON_PROPERTY_ESTATE_ID,
  SumGjeldOrdre.JSON_PROPERTY_OPPDRAGSNUMMER,
  SumGjeldOrdre.JSON_PROPERTY_REGISTERENHET,
  SumGjeldOrdre.JSON_PROPERTY_BESTILLER,
  SumGjeldOrdre.JSON_PROPERTY_MEGLERKONTOR,
  SumGjeldOrdre.JSON_PROPERTY_KONTAKTPERSON
})
...
public class SumGjeldOrdre {
  ...
  public SumGjeldOrdre() { 
  }

  public SumGjeldOrdre type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public SumGjeldOrdre ordreId(@javax.annotation.Nonnull String ordreId) {
  ...
  public SumGjeldOrdre estateId(@javax.annotation.Nullable String estateId) {
  ...
  public SumGjeldOrdre oppdragsnummer(@javax.annotation.Nullable String oppdragsnummer) {
  ...
  public SumGjeldOrdre registerenhet(@javax.annotation.Nonnull Registerenhet registerenhet) {
  ...
  public SumGjeldOrdre bestiller(@javax.annotation.Nonnull Kontaktinfo bestiller) {
  ...
  public SumGjeldOrdre meglerkontor(@javax.annotation.Nonnull Meglerkontor meglerkontor) {
  ...
  public SumGjeldOrdre kontaktperson(@javax.annotation.Nonnull Kontaktinfo kontaktperson) {
  ...
  /**
   * Return true if this SumGjeldOrdre object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SumGjeldOrdre sumGjeldOrdre = (SumGjeldOrdre) o;
    return Objects.equals(this.type, sumGjeldOrdre.type) &&
        Objects.equals(this.ordreId, sumGjeldOrdre.ordreId) &&
        Objects.equals(this.estateId, sumGjeldOrdre.estateId) &&
        Objects.equals(this.oppdragsnummer, sumGjeldOrdre.oppdragsnummer) &&
        Objects.equals(this.registerenhet, sumGjeldOrdre.registerenhet) &&
        Objects.equals(this.bestiller, sumGjeldOrdre.bestiller) &&
        Objects.equals(this.meglerkontor, sumGjeldOrdre.meglerkontor) &&
        Objects.equals(this.kontaktperson, sumGjeldOrdre.kontaktperson);
  }
