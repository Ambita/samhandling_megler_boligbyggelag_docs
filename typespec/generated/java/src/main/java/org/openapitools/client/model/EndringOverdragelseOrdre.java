 ...
 */
@JsonPropertyOrder({
  EndringOverdragelseOrdre.JSON_PROPERTY_TYPE,
  EndringOverdragelseOrdre.JSON_PROPERTY_SALGSMELDING_ORDRE_ID,
  EndringOverdragelseOrdre.JSON_PROPERTY_DATO_OVERDRAGELSE,
  EndringOverdragelseOrdre.JSON_PROPERTY_ORDRE_ID,
  EndringOverdragelseOrdre.JSON_PROPERTY_ESTATE_ID,
  EndringOverdragelseOrdre.JSON_PROPERTY_OPPDRAGSNUMMER,
  EndringOverdragelseOrdre.JSON_PROPERTY_REGISTERENHET,
  EndringOverdragelseOrdre.JSON_PROPERTY_BESTILLER,
  EndringOverdragelseOrdre.JSON_PROPERTY_MEGLERKONTOR,
  EndringOverdragelseOrdre.JSON_PROPERTY_KONTAKTPERSON
})
...
public class EndringOverdragelseOrdre {
  /**
   * Gets or Sets type
   */
  ...
  public static final String JSON_PROPERTY_SALGSMELDING_ORDRE_ID = "salgsmeldingOrdreId";
  @javax.annotation.Nonnull
  private String salgsmeldingOrdreId;
  ...
  public EndringOverdragelseOrdre() { 
  }

  public EndringOverdragelseOrdre type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public EndringOverdragelseOrdre salgsmeldingOrdreId(@javax.annotation.Nonnull String salgsmeldingOrdreId) {
    this.salgsmeldingOrdreId = salgsmeldingOrdreId;
    return this;
  }

  /**
   * Get salgsmeldingOrdreId
   * @return salgsmeldingOrdreId
   */
  @javax.annotation.Nonnull
  @JsonProperty(JSON_PROPERTY_SALGSMELDING_ORDRE_ID)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public String getSalgsmeldingOrdreId() {
    return salgsmeldingOrdreId;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SALGSMELDING_ORDRE_ID)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setSalgsmeldingOrdreId(@javax.annotation.Nonnull String salgsmeldingOrdreId) {
    this.salgsmeldingOrdreId = salgsmeldingOrdreId;
  }


  public EndringOverdragelseOrdre datoOverdragelse(@javax.annotation.Nonnull String datoOverdragelse) {
  ...
  public EndringOverdragelseOrdre ordreId(@javax.annotation.Nonnull String ordreId) {
  ...
  public EndringOverdragelseOrdre estateId(@javax.annotation.Nullable String estateId) {
  ...
  public EndringOverdragelseOrdre oppdragsnummer(@javax.annotation.Nullable String oppdragsnummer) {
  ...
  public EndringOverdragelseOrdre registerenhet(@javax.annotation.Nonnull Registerenhet registerenhet) {
  ...
  public EndringOverdragelseOrdre bestiller(@javax.annotation.Nonnull Kontaktinfo bestiller) {
  ...
  public EndringOverdragelseOrdre meglerkontor(@javax.annotation.Nonnull Meglerkontor meglerkontor) {
  ...
  public EndringOverdragelseOrdre kontaktperson(@javax.annotation.Nonnull Kontaktinfo kontaktperson) {
  ...
  /**
   * Return true if this EndringOverdragelseOrdre object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    EndringOverdragelseOrdre endringOverdragelseOrdre = (EndringOverdragelseOrdre) o;
    return Objects.equals(this.type, endringOverdragelseOrdre.type) &&
        Objects.equals(this.salgsmeldingOrdreId, endringOverdragelseOrdre.salgsmeldingOrdreId) &&
        Objects.equals(this.datoOverdragelse, endringOverdragelseOrdre.datoOverdragelse) &&
        Objects.equals(this.ordreId, endringOverdragelseOrdre.ordreId) &&
        Objects.equals(this.estateId, endringOverdragelseOrdre.estateId) &&
        Objects.equals(this.oppdragsnummer, endringOverdragelseOrdre.oppdragsnummer) &&
        Objects.equals(this.registerenhet, endringOverdragelseOrdre.registerenhet) &&
        Objects.equals(this.bestiller, endringOverdragelseOrdre.bestiller) &&
        Objects.equals(this.meglerkontor, endringOverdragelseOrdre.meglerkontor) &&
        Objects.equals(this.kontaktperson, endringOverdragelseOrdre.kontaktperson);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, salgsmeldingOrdreId, datoOverdragelse, ordreId, estateId, oppdragsnummer, registerenhet, bestiller, meglerkontor, kontaktperson);
  }
  ...
  public String toString() {
    ...
    sb.append("    salgsmeldingOrdreId: ").append(toIndentedString(salgsmeldingOrdreId)).append("\n");
