 ...
 */
@JsonPropertyOrder({
  SumFelleskostnaderOrdre.JSON_PROPERTY_TYPE,
  SumFelleskostnaderOrdre.JSON_PROPERTY_ORDRE_ID,
  SumFelleskostnaderOrdre.JSON_PROPERTY_ESTATE_ID,
  SumFelleskostnaderOrdre.JSON_PROPERTY_OPPDRAGSNUMMER,
  SumFelleskostnaderOrdre.JSON_PROPERTY_REGISTERENHET,
  SumFelleskostnaderOrdre.JSON_PROPERTY_BESTILLER,
  SumFelleskostnaderOrdre.JSON_PROPERTY_MEGLERKONTOR,
  SumFelleskostnaderOrdre.JSON_PROPERTY_KONTAKTPERSON
})
...
public class SumFelleskostnaderOrdre {
  /**
   * Gets or Sets type
   */
  ...
  public SumFelleskostnaderOrdre() { 
  }

  public SumFelleskostnaderOrdre type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public SumFelleskostnaderOrdre ordreId(@javax.annotation.Nonnull String ordreId) {
  ...
  public SumFelleskostnaderOrdre estateId(@javax.annotation.Nullable String estateId) {
  ...
  public SumFelleskostnaderOrdre oppdragsnummer(@javax.annotation.Nullable String oppdragsnummer) {
  ...
  public SumFelleskostnaderOrdre registerenhet(@javax.annotation.Nonnull Registerenhet registerenhet) {
  ...
  public SumFelleskostnaderOrdre bestiller(@javax.annotation.Nonnull Kontaktinfo bestiller) {
  ...
  public SumFelleskostnaderOrdre meglerkontor(@javax.annotation.Nonnull Meglerkontor meglerkontor) {
  ...
  public SumFelleskostnaderOrdre kontaktperson(@javax.annotation.Nonnull Kontaktinfo kontaktperson) {
  ...
  /**
   * Return true if this SumFelleskostnaderOrdre object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SumFelleskostnaderOrdre sumFelleskostnaderOrdre = (SumFelleskostnaderOrdre) o;
    return Objects.equals(this.type, sumFelleskostnaderOrdre.type) &&
        Objects.equals(this.ordreId, sumFelleskostnaderOrdre.ordreId) &&
        Objects.equals(this.estateId, sumFelleskostnaderOrdre.estateId) &&
        Objects.equals(this.oppdragsnummer, sumFelleskostnaderOrdre.oppdragsnummer) &&
        Objects.equals(this.registerenhet, sumFelleskostnaderOrdre.registerenhet) &&
        Objects.equals(this.bestiller, sumFelleskostnaderOrdre.bestiller) &&
        Objects.equals(this.meglerkontor, sumFelleskostnaderOrdre.meglerkontor) &&
        Objects.equals(this.kontaktperson, sumFelleskostnaderOrdre.kontaktperson);
  }
