 ...
 */
@JsonPropertyOrder({
  BasicResponse.JSON_PROPERTY_TYPE,
  BasicResponse.JSON_PROPERTY_ORDRE_ID,
  BasicResponse.JSON_PROPERTY_FORRETNINGSFORER,
  BasicResponse.JSON_PROPERTY_KLIENT,
  BasicResponse.JSON_PROPERTY_LEVERT,
  BasicResponse.JSON_PROPERTY_REFERANSE,
  BasicResponse.JSON_PROPERTY_EIERFORM
})
...
public class BasicResponse {
  ...
  public enum TypeEnum {
    ...
    FORHANDSUTLYSINGUTLOPT(String.valueOf("forhandsutlysingutlopt")),
    ...
    SUMGJELD(String.valueOf("sumgjeld")),
  ...
  public BasicResponse type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public BasicResponse ordreId(@javax.annotation.Nonnull String ordreId) {
  ...
  public BasicResponse forretningsforer(@javax.annotation.Nonnull BasicResponseForretningsforer forretningsforer) {
  ...
  public BasicResponse klient(@javax.annotation.Nullable Klient klient) {
    this.klient = klient;
    return this;
  }
  ...
  public BasicResponse levert(@javax.annotation.Nullable String levert) {
    this.levert = levert;
    return this;
  }
  ...
  public BasicResponse referanse(@javax.annotation.Nullable String referanse) {
  ...
  public BasicResponse eierform(@javax.annotation.Nullable EierformEnum eierform) {
  ...
  /**
   * Return true if this BasicResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.type, basicResponse.type) &&
        Objects.equals(this.ordreId, basicResponse.ordreId) &&
        Objects.equals(this.forretningsforer, basicResponse.forretningsforer) &&
        Objects.equals(this.klient, basicResponse.klient) &&
        Objects.equals(this.levert, basicResponse.levert) &&
        Objects.equals(this.referanse, basicResponse.referanse) &&
        Objects.equals(this.eierform, basicResponse.eierform);
  }
