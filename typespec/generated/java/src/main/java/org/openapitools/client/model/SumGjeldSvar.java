 ...
 */
@JsonPropertyOrder({
  SumGjeldSvar.JSON_PROPERTY_TYPE,
  SumGjeldSvar.JSON_PROPERTY_SUM_GJELD,
  SumGjeldSvar.JSON_PROPERTY_ORDRE_ID,
  SumGjeldSvar.JSON_PROPERTY_FORRETNINGSFORER,
  SumGjeldSvar.JSON_PROPERTY_KLIENT,
  SumGjeldSvar.JSON_PROPERTY_LEVERT,
  SumGjeldSvar.JSON_PROPERTY_REFERANSE,
  SumGjeldSvar.JSON_PROPERTY_EIERFORM
})
...
public class SumGjeldSvar {
  ...
  public static final String JSON_PROPERTY_SUM_GJELD = "sumGjeld";
  @javax.annotation.Nonnull
  private Integer sumGjeld;
  ...
  public SumGjeldSvar type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public SumGjeldSvar sumGjeld(@javax.annotation.Nonnull Integer sumGjeld) {
    this.sumGjeld = sumGjeld;
    return this;
  }
   ...
   */
  @javax.annotation.Nonnull
  @JsonProperty(JSON_PROPERTY_SUM_GJELD)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public Integer getSumGjeld() {
    return sumGjeld;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SUM_GJELD)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setSumGjeld(@javax.annotation.Nonnull Integer sumGjeld) {
    this.sumGjeld = sumGjeld;
  }


  public SumGjeldSvar ordreId(@javax.annotation.Nonnull String ordreId) {
  ...
  public SumGjeldSvar forretningsforer(@javax.annotation.Nonnull BasicResponseForretningsforer forretningsforer) {
  ...
  public SumGjeldSvar klient(@javax.annotation.Nullable Klient klient) {
    this.klient = klient;
    return this;
  }
  ...
  public SumGjeldSvar levert(@javax.annotation.Nullable String levert) {
    this.levert = levert;
    return this;
  }
  ...
  public SumGjeldSvar referanse(@javax.annotation.Nullable String referanse) {
  ...
  public SumGjeldSvar eierform(@javax.annotation.Nullable EierformEnum eierform) {
  ...
  /**
   * Return true if this SumGjeldSvar object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SumGjeldSvar sumGjeldSvar = (SumGjeldSvar) o;
    return Objects.equals(this.type, sumGjeldSvar.type) &&
        Objects.equals(this.sumGjeld, sumGjeldSvar.sumGjeld) &&
        Objects.equals(this.ordreId, sumGjeldSvar.ordreId) &&
        Objects.equals(this.forretningsforer, sumGjeldSvar.forretningsforer) &&
        Objects.equals(this.klient, sumGjeldSvar.klient) &&
        Objects.equals(this.levert, sumGjeldSvar.levert) &&
        Objects.equals(this.referanse, sumGjeldSvar.referanse) &&
        Objects.equals(this.eierform, sumGjeldSvar.eierform);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, sumGjeld, ordreId, forretningsforer, klient, levert, referanse, eierform);
  }
  ...
  public String toString() {
    ...
    sb.append("    sumGjeld: ").append(toIndentedString(sumGjeld)).append("\n");
