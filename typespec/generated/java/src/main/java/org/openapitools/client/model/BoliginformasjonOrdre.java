 ...
 */
@JsonPropertyOrder({
  BoliginformasjonOrdre.JSON_PROPERTY_TYPE,
  BoliginformasjonOrdre.JSON_PROPERTY_ORDRE_ID,
  BoliginformasjonOrdre.JSON_PROPERTY_ESTATE_ID,
  BoliginformasjonOrdre.JSON_PROPERTY_OPPDRAGSNUMMER,
  BoliginformasjonOrdre.JSON_PROPERTY_REGISTERENHET,
  BoliginformasjonOrdre.JSON_PROPERTY_BESTILLER,
  BoliginformasjonOrdre.JSON_PROPERTY_MEGLERKONTOR,
  BoliginformasjonOrdre.JSON_PROPERTY_KONTAKTPERSON
})
...
public class BoliginformasjonOrdre {
  /**
   * Gets or Sets type
   */
  ...
  public BoliginformasjonOrdre() { 
  }

  public BoliginformasjonOrdre type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public BoliginformasjonOrdre ordreId(@javax.annotation.Nonnull String ordreId) {
  ...
  public BoliginformasjonOrdre estateId(@javax.annotation.Nullable String estateId) {
  ...
  public BoliginformasjonOrdre oppdragsnummer(@javax.annotation.Nullable String oppdragsnummer) {
  ...
  public BoliginformasjonOrdre registerenhet(@javax.annotation.Nonnull Registerenhet registerenhet) {
  ...
  public BoliginformasjonOrdre bestiller(@javax.annotation.Nonnull Kontaktinfo bestiller) {
  ...
  public BoliginformasjonOrdre meglerkontor(@javax.annotation.Nonnull Meglerkontor meglerkontor) {
  ...
  public BoliginformasjonOrdre kontaktperson(@javax.annotation.Nonnull Kontaktinfo kontaktperson) {
  ...
  /**
   * Return true if this BoliginformasjonOrdre object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    BoliginformasjonOrdre boliginformasjonOrdre = (BoliginformasjonOrdre) o;
    return Objects.equals(this.type, boliginformasjonOrdre.type) &&
        Objects.equals(this.ordreId, boliginformasjonOrdre.ordreId) &&
        Objects.equals(this.estateId, boliginformasjonOrdre.estateId) &&
        Objects.equals(this.oppdragsnummer, boliginformasjonOrdre.oppdragsnummer) &&
        Objects.equals(this.registerenhet, boliginformasjonOrdre.registerenhet) &&
        Objects.equals(this.bestiller, boliginformasjonOrdre.bestiller) &&
        Objects.equals(this.meglerkontor, boliginformasjonOrdre.meglerkontor) &&
        Objects.equals(this.kontaktperson, boliginformasjonOrdre.kontaktperson);
  }
