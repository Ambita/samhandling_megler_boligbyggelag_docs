 ...
 */
@JsonPropertyOrder({
  ForhandsutlysingUtlopt.JSON_PROPERTY_TYPE,
  ForhandsutlysingUtlopt.JSON_PROPERTY_ORDRE_ID,
  ForhandsutlysingUtlopt.JSON_PROPERTY_FORRETNINGSFORER,
  ForhandsutlysingUtlopt.JSON_PROPERTY_KLIENT,
  ForhandsutlysingUtlopt.JSON_PROPERTY_LEVERT,
  ForhandsutlysingUtlopt.JSON_PROPERTY_REFERANSE,
  ForhandsutlysingUtlopt.JSON_PROPERTY_EIERFORM
})
...
public class ForhandsutlysingUtlopt {
  /**
   * Gets or Sets type
   */
  ...
  public ForhandsutlysingUtlopt() { 
  }

  public ForhandsutlysingUtlopt type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public ForhandsutlysingUtlopt ordreId(@javax.annotation.Nonnull String ordreId) {
  ...
  public ForhandsutlysingUtlopt forretningsforer(@javax.annotation.Nonnull BasicResponseForretningsforer forretningsforer) {
  ...
  public ForhandsutlysingUtlopt klient(@javax.annotation.Nullable Klient klient) {
    this.klient = klient;
    return this;
  }
  ...
  public ForhandsutlysingUtlopt levert(@javax.annotation.Nullable String levert) {
    this.levert = levert;
    return this;
  }
  ...
  public ForhandsutlysingUtlopt referanse(@javax.annotation.Nullable String referanse) {
  ...
  public ForhandsutlysingUtlopt eierform(@javax.annotation.Nullable EierformEnum eierform) {
  ...
  /**
   * Return true if this ForhandsutlysingUtlopt object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    ForhandsutlysingUtlopt forhandsutlysingUtlopt = (ForhandsutlysingUtlopt) o;
    return Objects.equals(this.type, forhandsutlysingUtlopt.type) &&
        Objects.equals(this.ordreId, forhandsutlysingUtlopt.ordreId) &&
        Objects.equals(this.forretningsforer, forhandsutlysingUtlopt.forretningsforer) &&
        Objects.equals(this.klient, forhandsutlysingUtlopt.klient) &&
        Objects.equals(this.levert, forhandsutlysingUtlopt.levert) &&
        Objects.equals(this.referanse, forhandsutlysingUtlopt.referanse) &&
        Objects.equals(this.eierform, forhandsutlysingUtlopt.eierform);
  }
