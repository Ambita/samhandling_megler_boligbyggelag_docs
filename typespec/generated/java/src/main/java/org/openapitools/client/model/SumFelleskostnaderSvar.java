 ...
 */
@JsonPropertyOrder({
  SumFelleskostnaderSvar.JSON_PROPERTY_TYPE,
  SumFelleskostnaderSvar.JSON_PROPERTY_SUM_FELLESKOSTNADER,
  SumFelleskostnaderSvar.JSON_PROPERTY_ORDRE_ID,
  SumFelleskostnaderSvar.JSON_PROPERTY_FORRETNINGSFORER,
  SumFelleskostnaderSvar.JSON_PROPERTY_KLIENT,
  SumFelleskostnaderSvar.JSON_PROPERTY_LEVERT,
  SumFelleskostnaderSvar.JSON_PROPERTY_REFERANSE,
  SumFelleskostnaderSvar.JSON_PROPERTY_EIERFORM
})
...
public class SumFelleskostnaderSvar {
  /**
   * Gets or Sets type
   */
  public enum TypeEnum {
    SUMFELLESKOSTNADER(String.valueOf("sumfelleskostnader"));
  ...
  public static final String JSON_PROPERTY_SUM_FELLESKOSTNADER = "sumFelleskostnader";
  @javax.annotation.Nonnull
  private Integer sumFelleskostnader;
  ...
  public SumFelleskostnaderSvar() { 
  }

  public SumFelleskostnaderSvar type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public SumFelleskostnaderSvar sumFelleskostnader(@javax.annotation.Nonnull Integer sumFelleskostnader) {
    this.sumFelleskostnader = sumFelleskostnader;
    return this;
  }

  /**
   * Get sumFelleskostnader
   * @return sumFelleskostnader
   */
  @javax.annotation.Nonnull
  @JsonProperty(JSON_PROPERTY_SUM_FELLESKOSTNADER)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public Integer getSumFelleskostnader() {
    return sumFelleskostnader;
  }
  ...
  @JsonProperty(JSON_PROPERTY_SUM_FELLESKOSTNADER)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setSumFelleskostnader(@javax.annotation.Nonnull Integer sumFelleskostnader) {
    this.sumFelleskostnader = sumFelleskostnader;
  }


  public SumFelleskostnaderSvar ordreId(@javax.annotation.Nonnull String ordreId) {
  ...
  public SumFelleskostnaderSvar forretningsforer(@javax.annotation.Nonnull BasicResponseForretningsforer forretningsforer) {
  ...
  public SumFelleskostnaderSvar klient(@javax.annotation.Nullable Klient klient) {
    this.klient = klient;
    return this;
  }
  ...
  public SumFelleskostnaderSvar levert(@javax.annotation.Nullable String levert) {
    this.levert = levert;
    return this;
  }
  ...
  public SumFelleskostnaderSvar referanse(@javax.annotation.Nullable String referanse) {
  ...
  public SumFelleskostnaderSvar eierform(@javax.annotation.Nullable EierformEnum eierform) {
  ...
  /**
   * Return true if this SumFelleskostnaderSvar object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SumFelleskostnaderSvar sumFelleskostnaderSvar = (SumFelleskostnaderSvar) o;
    return Objects.equals(this.type, sumFelleskostnaderSvar.type) &&
        Objects.equals(this.sumFelleskostnader, sumFelleskostnaderSvar.sumFelleskostnader) &&
        Objects.equals(this.ordreId, sumFelleskostnaderSvar.ordreId) &&
        Objects.equals(this.forretningsforer, sumFelleskostnaderSvar.forretningsforer) &&
        Objects.equals(this.klient, sumFelleskostnaderSvar.klient) &&
        Objects.equals(this.levert, sumFelleskostnaderSvar.levert) &&
        Objects.equals(this.referanse, sumFelleskostnaderSvar.referanse) &&
        Objects.equals(this.eierform, sumFelleskostnaderSvar.eierform);
  }

  @Override
  public int hashCode() {
    return Objects.hash(type, sumFelleskostnader, ordreId, forretningsforer, klient, levert, referanse, eierform);
  }
  ...
  public String toString() {
    ...
    sb.append("    sumFelleskostnader: ").append(toIndentedString(sumFelleskostnader)).append("\n");
